    ...
    <div className="w-full bg-[#050e1f] font-sans text-white overflow-x-hidden selection:bg-amber-500 selection:text-black">
      ...
      <section className="relative w-full min-h-[85vh] lg:min-h-[90vh] flex flex-col justify-between overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center my-auto py-16 space-y-4">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-wide uppercase text-white drop-shadow-[0_4px_16px_rgba(245,158,11,0.5)]">
            PT. INTEGRA ANEKSA KREASINDO
          </h1>

          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold tracking-tight text-white/95">
            Media Advertising &amp; Event Organizer
          </h2>

          <p className="text-xs sm:text-sm text-neutral-300 max-w-2xl mx-auto pt-2 font-medium">
